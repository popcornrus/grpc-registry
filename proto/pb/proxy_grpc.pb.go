...
func (c *proxyServiceClient) GetServerDetails(ctx context.Context, in *ServerDetailsRequest, opts ...grpc.CallOption) (*ServerDetailsResponse, error) {
	out := new(ServerDetailsResponse)
	err := c.cc.Invoke(ctx, "/proxy.ProxyService/GetServerDetails", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProxyServiceServer) GetServerDetails(context.Context, *ServerDetailsRequest) (*ServerDetailsResponse, error) {
...
func _ProxyService_GetServerDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ServerDetailsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProxyServiceServer).GetServerDetails(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proxy.ProxyService/GetServerDetails",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProxyServiceServer).GetServerDetails(ctx, req.(*ServerDetailsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProxyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProxyService_GetServerDetails_Handler,
		},
		{
